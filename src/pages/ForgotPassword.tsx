...
const ForgotPassword: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFB347] via-[#FFE0B2] to-white px-2 md:px-8">
      <div className="flex flex-col md:flex-row justify-between w-full max-w-5xl bg-transparent shadow-none md:shadow-2xl overflow-hidden md:h-[600px]">
        ...
        <div className="w-full md:w-[50%] flex flex-col justify-between p-6 md:p-10">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 md:justify-start mt-4">
            <button
              type="button"
              className="flex items-center border border-gray-900 rounded-lg px-4 py-2 text-gray-700 shadow-sm font-medium"
            >
              <span className="mr-2">
                {/* علم بريطانيا SVG */}
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <rect width="24" height="24" fill="#00247d" />
                  <path d="M0 0L24 24M24 0L0 24" stroke="#fff" strokeWidth="2" />
                  <path d="M12 0V24M0 12H24" stroke="#fff" strokeWidth="4" />
                  <path d="M0 0L24 24M24 0L0 24" stroke="#cf142b" strokeWidth="1" />
            ...
            <Link to="#" className="hover:underline text-[#cc7f15]">Terms</Link>
            <Link to="#" className="hover:underline text-[#cc7f15]">Plans</Link>
            <Link to="#" className="hover:underline text-[#cc7f15]">Contact Us</Link>
          </div>
        </div>
        {/* Right Side (Sign Up Form) */}
        <div className="w-full md:w-[50%] flex items-center justify-center bg-white rounded-lg shadow-2xl p-4 md:p-0">
          <form className="w-full max-w-xs sm:max-w-sm space-y-8 my-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between pt-10 gap-4 sm:gap-0">
              <button className="w-full sm:w-[45%] text-white bg-[#E6911E] hover:bg-[#cc7f15] font-bold rounded-lg text-base px-5 py-2 text-center transition-colors shadow-lg">
                Submit
              </button>
              <button className="w-full sm:w-[45%] text-black hover:bg-[#cc7f15] font-bold rounded-lg text-base px-5 py-2 text-center transition-colors shadow-lg">
                Sign Up
              </button>
            </div>
          </form>
