...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFB347] via-[#FFE0B2] to-white px-20">
      <div className="flex justify-between  w-[70%] max-w-5xl bg-transparent  shadow-none md:shadow-2xl overflow-hidden md:h-[600px]">
        ...
        <div className=" px-5 w-[40%] flex items-center justify-center bg-white rounded-lg shadow-2xl    ">
          <form className="w-full max-w-xs md:max-w-sm space-y-3 my-12 ">
            ...
            <div>
              ...
              <input
                type="email"
                id="email"
                className="form-input py-1 block w-full rounded-lg border border-gray-300 focus:ring-orange-400 focus:border-orange-400 text-base"
            ...
            <div className="flex justify-between pt-10">
              <button className=" w-[45%]  text-white bg-orange-500 hover:bg-orange-600 font-bold rounded-lg text-base px-5 py-2 text-center transition-colors shadow-lg">
                Submit
              </button>
              <button className=" w-[45%]   text-black hover:bg-orange-600 font-bold rounded-lg text-base px-5 py-2 text-center transition-colors shadow-lg">
                Sign Up
              </button>
            </div>
          </form>
