        ...
        <div className="flex flex-col md:flex-row gap-8 mt-8">
            ...
            <div className="bg-white flex flex-col gap-12 ">
              ...
              <div className="shadow-lg rounded-xl flex flex-col pb-5 gap-3">
                ...
                <div className=" text-gray-400 px-8">
                  <div className="flex justify-between "><p>14% Tax </p><p>$200.00</p></div>
                  <div className="flex justify-between "><p>14% Tax </p><p>$200.00</p></div>
                  <div className="flex justify-between "><p>14% Tax </p><p>$200.00</p></div>
                </div>
              </div>
          ...
          <div className="w-full md:w-2/3 flex flex-col gap-6">
            <div className="bg-white rounded-xl p-6 flex flex-col gap-8">
              <h3 className="font-bold text-center text-lg mb-4">Login or Sign up to book</h3>
              <form className="flex flex-col gap-8">
                <input type="email" placeholder="Email" className="border border-[#cdcac5] rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#E6911E]" />
                <input type="password" placeholder="Password" className="border border-[#cdcac5] rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#E6911E]" />
                <Link to="/payment" className="w-full bg-[#E6911E] hover:bg-[#E6911E] font-semibold py-2 rounded-lg mt-2 transition text-white flex items-center justify-center">Sign in</Link>
              </form>
              <div className="text-sm mt-2 text-center">Don&apos;t have an account? <a href="#" className="text-[#E6911E] hover:underline">Sign Up</a></div>
