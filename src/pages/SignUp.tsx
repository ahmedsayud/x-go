          ...
          <form className="w-full max-w-xs md:max-w-sm space-y-3 my-12 ">
            ...
            <div className="flex items-center">
              <input
                id="terms"
                type="checkbox"
                className="form-checkbox rounded border-gray-300 text-orange-500 focus:ring-orange-400"
                required
              />
            ...
            <button
              type="submit"
              className="w-full mt-10 text-white bg-orange-500 hover:bg-orange-600 font-bold rounded-lg text-base px-5 py-2 text-center transition-colors shadow-lg"
            >
              Sign Up
            </button>
