...
import Vector6 from "../assets/Car Details Card Icon/Frame 227.png";
import Vector7 from "../assets/Car Details Card Icon/Vector (7).png";
import solar_arrow_up_bold from "../assets/Car Details Card Icon/solar_arrow-up-bold.png";
...
const CarDetailsCard: React.FC<CarDetailsCardProps> = ({
  ...
  <div className="bg-gray-50 rounded-xl shadow-md w-full h-[391px] flex flex-col p-4">
    <img
      src={image}
      alt={name}
      className="rounded-xl object-cover w-full h-[180px] mb-4"
    />
